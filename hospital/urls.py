...
urlpatterns = [
    ...
    path('opd/appointments/<int:pk>/edit/', views.opd_appointment_edit, name='opd_appointment_edit'),
    path('opd/appointments/<int:pk>/delete/', views.opd_appointment_delete, name='opd_appointment_delete'),
