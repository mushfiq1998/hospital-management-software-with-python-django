...
urlpatterns = [
    ...
    path('ipd/admissions/<int:pk>/edit/', views.ipd_admission_edit, name='ipd_admission_edit'),
    path('ipd/admissions/<int:pk>/discharge/', views.ipd_admission_discharge, name='ipd_admission_discharge'),
]
